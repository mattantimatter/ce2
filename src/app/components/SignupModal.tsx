                ...
                <div className="flex flex-col md:flex-row min-h-[600px]">
                    ...
                    <div className="w-full md:w-1/2 bg-white p-12 flex flex-col justify-center">
                        ...
                        <div className="space-y-3">
                            <button className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-black text-white rounded-xl hover:bg-gray-800 transition-colors duration-200 font-medium">
                            ...
                            <button className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white text-gray-900 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200 font-medium">
