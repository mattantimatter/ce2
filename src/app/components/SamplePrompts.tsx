    ...
    return (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center gap-8 pointer-events-none max-w-4xl w-full px-4 transition-opacity duration-300">
            <div className="flex flex-col items-center gap-3">
                <h1 className="text-5xl font-semibold dark:text-white text-gray-900">
                    Chat with C1
                </h1>
            ...
            <div className="flex flex-col items-center gap-4 w-full max-w-2xl pointer-events-auto">
                <div className="flex items-center gap-2">
                    <span className="dark:text-white/70 text-gray-700 text-sm font-medium">Generate Artifacts</span>
                    <span className="px-2 py-0.5 bg-blue-500/20 border border-blue-500/30 rounded-full dark:text-blue-400 text-blue-600 text-xs font-medium">NEW</span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                    {artifacts.map((artifact, index) => (
                        <button
                            ...
                            className="flex items-center gap-3 px-6 py-4 bg-white/5 dark:bg-white/5 bg-gray-200/50 backdrop-blur-sm border dark:border-white/10 border-gray-300 rounded-2xl text-left dark:text-white/90 text-gray-900 hover:bg-white/10 dark:hover:bg-white/10 hover:bg-gray-200 dark:hover:border-white/20 hover:border-gray-400 transition-all duration-200 cursor-pointer"
                        >
